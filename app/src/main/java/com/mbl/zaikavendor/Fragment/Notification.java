...
import com.mbl.zaikavendor.adapter.Notificationadapter;
...
public class Notification extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new Notificationadapter(v.getContext(), R.layout.notificationitem, actorsList);
        listView.setAdapter(adapter);

        new JSONAsyncTask().execute(EndPoints.NOTIFICATION + "?category_id=" + userid+"&ordertype=3"+"&userid2="+userid2);
            ...
            try {
                ...
                if (status == 200) {
                    ...
                    for (int i = 0; i < jarray.length(); i++) {
                        ...
                        actor.setName((object.getString("notype")).trim());  //subloc
                        actor.setCountry((object.getString("details")).trim()); //date
                        actor.setSpouse((object.getString("trno")).trim()); //total
